...
exports.deleteItem = exports.updateItem = exports.createItem = exports.getItemByUserId = exports.getItemNameID = exports.getItens = void 0;
...
const getItemByUserId = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    if (userId) {
        return yield Model_1.List.find({ userId }).exec();
    }
    return null;
});
